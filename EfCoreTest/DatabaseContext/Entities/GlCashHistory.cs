...
{
    public partial class GlCashHistory
    {
        ...
        public string ReconciledFlag { get; set; }
        ...
        public int? PpExportBatchNo { get; set; }
        public string PpExportBatchId { get; set; }
        public int? PpExportVoidBatchNo { get; set; }
        public string PpExportVoidBatchId { get; set; }
        public int? PaychkSequenceNo { get; set; }
        public string PaychkSequenceId { get; set; }
