...
namespace FSI.ClientMgmtTool.Backend.Foundation.DatabaseContext.Entities
{
    public partial class Submittals
    {
        public Submittals()
        {
            ...
            SubmittalAttachmentsSubmittals = new HashSet<SubmittalAttachments>();
            SubmittalAttachmentsSubmittalsNavigation = new HashSet<SubmittalAttachments>();
        ...
        public DateTime? BeginPrepOn { get; set; }
        ...
        public ICollection<SubmittalAttachments> SubmittalAttachmentsSubmittals { get; set; }
        public ICollection<SubmittalAttachments> SubmittalAttachmentsSubmittalsNavigation { get; set; }
