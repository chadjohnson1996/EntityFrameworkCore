...
{
    public partial class AiaHeader
    {
        public AiaHeader()
        {
            AiaHeaderDivision = new HashSet<AiaHeaderDivision>();
            AiaHeaderHistory = new HashSet<AiaHeaderHistory>();
        ...
        public string AiaRollback { get; set; }
        ...
        public AiaHeaderBackup AiaHeaderBackup { get; set; }
        public ICollection<AiaHeaderDivision> AiaHeaderDivision { get; set; }
        public ICollection<AiaHeaderHistory> AiaHeaderHistory { get; set; }
