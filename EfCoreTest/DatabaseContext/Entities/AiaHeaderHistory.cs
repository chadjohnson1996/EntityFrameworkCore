...
{
    public partial class AiaHeaderHistory
    {
        public AiaHeaderHistory()
        {
            AiaItemHistory = new HashSet<AiaItemHistory>();
        }
        ...
        public ICollection<AiaItemHistory> AiaItemHistory { get; set; }
    }
}
